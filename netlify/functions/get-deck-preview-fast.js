...
//
// Request body: { "url": "https://curiosa.io/decks/<id>" }
...
exports.handler = async function (event) {
  ...
  const pageUrl = deckId ? ('https://curiosa.io/decks/' + deckId) : url;
  ...
  if (deckId) {
    ...
    for (const proc of candidates) {
      const apiUrl = 'https://curiosa.io/api/trpc/' + proc + '?batch=1&input=' +
