...
There are two ways to accomplish this:<br>
    ...
    Option 2: Menu in browser > Add to Home screen, Install or Install as App <br>

# Important Info

**Don't lose your Data!** 
To have persistent **Card, Deck and App Data**, you need to **export a Backup** or **Export decks**, as clearing browser cache and history will clear all data. You can also store the decks on [Cuiosa](https://curiosa.io/) and import using the deck name or URL
